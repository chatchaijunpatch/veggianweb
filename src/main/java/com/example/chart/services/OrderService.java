...
public class OrderService {
    ...
    public List<VegOrder> getAll() {
        String url = "https://veggian-api.herokuapp.com/order";
...
//                    System.out.println(list1.get(k).trim());
    ...
    {
        String url = "https://veggian-api.herokuapp.com/order/" + id;
    ...
    public void update(VegOrder vegetable) {
        String url = "https://veggian-api.herokuapp.com/order/" + vegetable.getOrder_Id();

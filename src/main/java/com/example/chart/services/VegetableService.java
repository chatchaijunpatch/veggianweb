...
public class VegetableService {
    ...
    public List<Vegetable> getAll() {
        String url = "https://veggian-api.herokuapp.com/vegetable";
    ...
    {
        String url = "https://veggian-api.herokuapp.com/vegetable/" + id;
    ...
    public void update(List<Cart> cart){
        for (int i =0; i <cart.size();i++){
            ...
            String url = "https://veggian-api.herokuapp.com/vegetable/" + update.getId();
